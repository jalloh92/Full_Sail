...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactBox = __webpack_require__(159);
	...
	_reactDom2['default'].render(_react2['default'].createElement(App, { url: '/api/contacts', pollInterval: 2000 }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactsList = __webpack_require__(160);

	var _ContactsList2 = _interopRequireDefault(_ContactsList);

	var _ContactForm = __webpack_require__(162);

	var _ContactForm2 = _interopRequireDefault(_ContactForm);

	// Define class "ContactBox" ********************************
	// Parent is App
	var ContactBox = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_ContactsList2['default'], { data: this.state.data }),
	      _react2['default'].createElement(
	        'h3',
	        null,
	        'Contact Form'
	      ),
	      _react2['default'].createElement(_ContactForm2['default'], { onContactSubmit: this.handleContactSubmit })
	    );
	  }
	});
		...
		_createClass(ContactsList, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'ul',
					null,
					this.props.data.map(function (contact) {
