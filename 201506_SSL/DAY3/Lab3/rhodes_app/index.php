  ...
  <body>
        ...
        <div class="col-md-6">
          <form class="form-signin " enctype="multipart/form-data" action="registered.php" method="post" enctype="multipart/form-data">
            ...
            <input class="form-control" name="captcha" id="captcha" placeholder="Captcha Verify"/>
            <img class="form-control" src="captcha.php" />
            <button class="btn btn-lg btn-primary btn-block" type="submit">Register</button>
          </form>
        </div><!-- closes registration form container -->  

        <!-- Login Form -->
        <div class="col-md-6">
          <form action="login.php" method="post" class="form-signin col-md-6">
            <h2 class="form-signin-heading">Ready to Login?</h2>
            <input type="text" class="form-control" name="username_li" placeholder="Username">
            <input type="text" class="form-control" name="password_li" placeholder="Password">
            <button class="btn btn-lg btn-primary btn-block" type="submit">Log In</button>      
          </form>
        </div><!-- closes log in form container -->
