<?php
// ADD if using session variables to password form fields
session_start();
?>
    ...
    <center><img src="images/kelly_photo.jpg" width=150 height=150><br><br>
    <a href="http://localhost:8888/DAY4/Lecture4/Activity/upload_form.php">Upload Form</a><br><br></center>
...
<?php
    ...
    $euser =  $_POST['user'];
    $eavatar =  $_POST['profilePhoto'];   

    // var_dump for debugging
    var_dump(get_defined_vars());

    return array("USER_NAME" => $euser, "PASSWORD" => $epass, "Profile_Photo" => $eavatar);
    }
...
// STEP #2:  Scroll down and grab the new code for the upload form
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            echo "Sorry, there was an error... there was a problem uploading your file.<br><br>";
            echo "<a href='http://localhost:8888/SSL-1506_MyClassActivities/Day3/Lecture3/Activity/upload_form.php'>Try again?</a><br><br>";
